...
<head>
    ...
    <title>CV. KAYAN RIVER || Pemesanan</title>
    <!-- Custom Theme Style -->
    ...
    include "opt_login.php";
     ?>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">Pemesanan Dekorasi Wedding</div>
          <div class="panel-body">
          <h4>Pesan Dekorasi Wedding Anda Dan Segera Lakukan Pembayaran </h4>
          <hr>
