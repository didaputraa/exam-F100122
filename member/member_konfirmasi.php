...
<html lang="en">
<head>
  <title>CV. Kayan River|| Konfirmasi</title>
  <meta charset="utf-8">
...
$sql = "UPDATE member SET ver_code=NULL WHERE ver_code='$passkey'";
...
if($result)
{
    echo '
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <h3><b>Akun Anda Telah Aktif Silahkan <a href="#" data-toggle="modal" data-target="#myModal">Login</a></b></h3>
        </div>
      </div>
';
}
