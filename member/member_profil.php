...
<html lang="en">
<head>
  <title>CV. Kayan River || Halaman Member</title>
  <meta charset="utf-8">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container">
         <br>
         <p class="w3-center"><img src="assets/foto_member/<?php echo $sql_sel['foto']; ?>" class="w3-circle" style="height:106px;width:106px;object-fit:cover" alt="Avatar"></p> <br>
