              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                       <?php 
		$sql_sel = "select * from transaksi where jenis_bayar = 'off cod'"; //variabel berisi bahasa query untuk memilih data di tabel transaksi yang jenis bayar = off cod (pesan langsung kepada operator tempat futsal)
