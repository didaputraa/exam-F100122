<!-- page content -->
		...
		?>
          <tr>
             ...
             <td class="center">
			<?php 
			$q = mysqli_query($koneksi, "select * from bayar_transfer where id_book='$sql_res[id_book]' limit 1");
			$l = mysqli_fetch_array($q);
			
			if (empty($l)) {
				
				echo "<img width=\"90\" height=\"30\" alt=\"Belum Upload\">";
				
			} else {
				echo "<img src=\"../assets/bukti_bayar/{$l['bukti_bayar']}\" width=\"90\" height=\"30\" alt=\"Belum Upload\">";
			}
			?>
             </td>
        ...
        <?php
			if(isset($_POST['kirim'])){
				...
				//format email yang akan dikirim ke email pemesan
					...
					//sender
					$sender = "kayanriver.member@gmail.com";
