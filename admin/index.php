    ...
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><img src="../assets/images/logo.png" style="width:30px; height:30px;"> <span>CV. Kayan River</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-th-list"></i> Data Master <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index.php?url=lap"> Jenis Produk</a></li>
                    </ul>
                  </li>
		...
		if(isset($_GET['url'])){
			...
			elseif ($_GET['url'] == 'lap-edit') {
				include 'adm_data_lap_edit.php';
			}
