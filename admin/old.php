...
<html lang="en">
<head>
  <title>Kayan River|| Maintenance</title>
  <meta charset="utf-8">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container">
         ...
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Kayan River Admin</p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> Username</p>
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> Juli 11, 1998</p>
        </div>
      </div>
      <br>
