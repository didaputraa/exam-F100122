      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" name="modal_popup" action="lap_pro_edit.php" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <div class="col-sm-8">
               <input type="text" class="form-control" name="id_lap" id="id_lap" placeholder="Kode Produk" value="<?php echo $sql_res['id_lap']; ?>" readonly>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select class="form-control" name="jenis_rumput">
                <option>--- Pilih Jenis Produk ---</option>
            	 <option value="sintetis" <?php if($sql_res['jenis_rumput']=="sintetis"){echo "selected";} ?>>Tenda</option>
                <option value="beton/semen" <?php if($sql_res['jenis_rumput']=="beton/semen"){echo "selected";} ?>>Sound System</option>
                <option value="dekorasi" <?php if($sql_res['jenis_rumput']=="dekorasi"){echo "selected";} ?>>Dekorasi</option>
                <option value="kursi" <?php if($sql_res['jenis_rumput']=="kursi"){echo "selected";} ?>>kursi</option>
                        </select>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" id="pwd" name="no_lap" placeholder="Nomor Produk" value="<?php echo $sql_res['no_lap']; ?>">
            </div>
          </div>
          <div class="form-group">
