...
<html lang="en">
<head>
  <title>CV. Kayan River|| Pendaftaran Operator</title>
  <meta charset="utf-8">
  ...
  <div class="container">
    ...
    <form class="form-horizontal" action="opt_pro_reg.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        <div class="col-sm-1"></div>
        <label class="control-label col-sm-3" for="email">Nama Tempat Wedding</label>
        <div class="col-sm-4">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-sm-1"></div>
                <label class="control-label col-sm-3">Alamat Tempat Wedding</label>
                <div class="col-sm-4">
