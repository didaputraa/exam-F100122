...
<footer class="container footer-distributed">
	...
	<div class="footer-left">
		...
		<h3><img src="assets/images/logo.png" width="50px" height="50px" />&nbsp;CV.<span>Kayan River</span></h3>
		...
		<p class="footer-company-name">Kayan River Team &copy; 2021 </a></p>
	</div>
	...
	<div class="footer-right">
		...
		if (isset($_POST['kirim'])) { //ketika tombol kirim ditekan maka akan menjalankan code bagian ini
			...
			$email = "kayanriver@gmail.com"; //email penerima
			$to = $email;  //email penerima
			$subject = "Kritik Dan Saran dari $nama"; //subject pesan pada email

			//sender
			$sender = "kayanriver.member@gmail.com"; //email pengirim
