...
<html lang="en">
<head>
  <title>Kayan River || Search</title>
  <meta charset="utf-8">
          ...
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container" style="padding-bottom:10px">
             ...
             <select class="w3-select" name="harga">
              ...
              <option value="0-100000">0-400000</option>
              <option value="100001-125000">400000-1500000</option>
              <option value="1500000-10000000">1500000-10000000</option>
            </select>
            ...
            <select class="w3-select" name="jenis">
              ...
              <!-- <option value="sintetis">FULL SET DEKORASI</option>
              <option value="sintetis">PAKET MEJA PRASMANAN DAN MEJA BUNDAR</option>
              <option value="sintetis">KURSI PLASTIK</option>
              <option value="sintetis">KURSI FUTURA VIP</option>
              <option value="sintetis">PAKET LENGKAP SOUND SYSTEM</option>
              <option value="sintetis">ELECTOUN ( YAMAHA )</option> -->
          ...
          <div class="w3-container w3-card-2 w3-white w3-round" style="margin-left: 10px; margin-top:10px;"><br>
              ...
              <div class="w3-row-padding" style="margin:0 -16px">
                ...
                <div class="w3-half">
                  ...
                  <i class="fa fa-list-alt" aria-hidden="true"></i> Nama Produk &nbsp;<?php echo $r['no_lap']; ?><br><br>
                  <i class="fa fa-life-ring" aria-hidden="true"></i> Jenis prosuk <?php echo $r['jenis_rumput']; ?><br><br>
                  <i class="fa fa-tags" aria-hidden="true"></i> Rp. <?php echo $r['harga']; ?> per unit<br><br><br><br>
