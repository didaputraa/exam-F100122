...
<html lang="en">
<head>
  <title>CV.Kayan River || Home</title>
     ...
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
         ...
         <div class="carousel-inner" role="listbox">
           <div class="item active">
             <img src="assets/kayan/8.jpg" alt="Image">
           ...
           <div class="item">
             <img src="assets/kayan/9.jpg" alt="Image">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/kayan/10.jpg" alt="Image">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/kayan/11.jpg" alt="Image">
             <div class="carousel-caption">
    ...
    <div class="w3-container w3-card-2 w3-white w3-round" style="margin-left: 10px; margin-top:10px;"><br>
              ...
              <div class="w3-row-padding" style="margin:0 -16px">
                ...
                <div class="w3-half">
                  ...
                  <i class="fa fa-list-alt" aria-hidden="true"></i> Produk Nomor&nbsp;<?php echo $r['no_lap']; ?><br><br>
                  <i class="fa fa-life-ring" aria-hidden="true"></i> Jenis Produk : <?php echo $r['jenis_rumput']; ?><br><br>
